...
# After creating the AMI it is possible define a userAccount to sharing the NEW AMI
...
def lambda_handler(event, context):
    ...
    for instance in instances:
        ...
        #        vol_id, instance['InstanceId'])
            ...
            #definisco un time per consentire all'ami di crearsi prima di modificare gli attributi
           
            time.sleep(15)
            image = ec2.Image(AMIid['ImageId'])
            
            #definisco lo userid a cui condividere l'AMI
